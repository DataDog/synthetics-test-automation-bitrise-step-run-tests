...
| `mobile_application_version`           | Override the mobile application version for Synthetic mobile application tests. The version must be uploaded and available within Datadog. You can use the [Bitrise step to upload an application][11] and use its `DATADOG_UPLOADED_APPLICATION_VERSION_ID` output here. <br><sub>**Default:** none</sub> |
